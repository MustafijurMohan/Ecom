...
const Navbar = () => {
  ...
  return (
    <>
        <div className="flex justify-between items-center py-8 font-medium sm:sticky sm:top-0 sm:h-9 sm:bg-white sm:z-10">
            ...
            <div className="flex items-center gap-6">
                ...
                <div className='group relative'>
                    ...
                    {
                        token && 
                        <div className='hidden group-hover:block absolute dropdown-menu right-0 pt-5'>
                ...
                <Link to='/cart' className='relative'>
                    ...
                    <p className='absolute right-[-5px] bottom-[-5px] w-4 leading-4 bg-black text-white text-center text-[8px] aspect-square rounded-full'>{getCartCount()}</p>
                </Link>
